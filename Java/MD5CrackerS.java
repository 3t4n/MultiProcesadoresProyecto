...
public class MD5CrackerS   {
	...
	public MD5CrackerS(String prefixes[], long length, long off_start, long off_end, long prefix_to_calc,   String password,long start, long end) {
	...
	public void computeDirectly() {
			...
			if(password.length() == 0){
				if (MD5CrackerS.getMd5(	prefixes[(int)(off_end + i) ]).equals( hash))
				{
	...
	public static void main(String args[]) {
		...
		for (int i = 0; i < Utils.N; i++) {
			...
			MD5CrackerS obj = new MD5CrackerS(prefixes, j,  offset_start,  offset_end,  prefix_n,   password, 0,  prefix_n);
			obj.computeDirectly();
			if(!password.equals("")){
